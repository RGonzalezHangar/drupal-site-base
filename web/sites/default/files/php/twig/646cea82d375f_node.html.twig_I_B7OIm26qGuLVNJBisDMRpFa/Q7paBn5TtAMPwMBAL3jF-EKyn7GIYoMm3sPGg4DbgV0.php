...
/* themes/ohg_docs_site/templates/content/node.html.twig */
class __TwigTemplate_485e6a118ef03eaa44c77f3be16107da extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 77, $this->source)))) : (""))];
        // line 80
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("ohg_docs_site/node"), "html", null, true);
        echo "
<article";
        // line 81
...
";
    ...
    {
        return "themes/ohg_docs_site/templates/content/node.html.twig";
    }
    ...
    {
        return new Source("", "themes/ohg_docs_site/templates/content/node.html.twig", "/var/www/html/cellsearchdocs/web/themes/ohg_docs_site/templates/content/node.html.twig");
    }
